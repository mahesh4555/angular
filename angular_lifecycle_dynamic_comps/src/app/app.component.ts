import { Component ,  ViewChild, DoCheck, AfterViewInit} from '@angular/core';
...
export class AppComponent implements DoCheck, AfterViewInit {
  ...
  public depParent : string = "PARENT";
  ...
  ngDoCheck(){
    console.log("AppComp ngDocheck")
    console.log(this.viewchild)
    // this.viewChild.depchild = "A"; // cannot be accessed before ngAfterViewInit
    // this.viewchild.depParent = "A";
    // this.viewchild.show = true;
  }

  ngAfterViewInit(){

    this.viewchild.depchild ="A";
    // this.viewchild.depParent ="B";
